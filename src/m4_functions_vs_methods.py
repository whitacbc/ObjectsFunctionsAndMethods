...
def try_methods_and_functions():
    ...
    """
    Gram =  rg.SimpleTurtle()
    Gram.pen = rg.Pen('blue',5)
    Gram.backward(150)
    Gram.speed = 1
    draw_many_squares(Gram,2,100,30)
    Gram.speed = 5
    Gram.pen = rg.Pen('red',5)
    draw_many_squares(Gram,10,50,15)
    Gram.speed = 100
    Gram.pen = rg.Pen('red',35)
    draw_many_squares(Gram,8,300,60)
    Gram.pen = rg.Pen('black',3)
    Gram.backward(200)
    Gram.draw_circle(30)
    Gram.draw_square(50)
    ####################################################################
