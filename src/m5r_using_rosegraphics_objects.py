...
#            It attaches the window to the objects (square and circle) so that
# both are displayed
#
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            if the window  the is not closed then the the next example will
#  open a new window and not wait for the first to be closed
#
